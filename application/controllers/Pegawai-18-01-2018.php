...
/*PROSES TAMBAH PROFIL PEGAWAI*/
        ...
        function ambil_unitkerja()
	{
	        $state=$this->input->post('state');
                ...
                foreach($query->result() as $row)
                {
                 echo "<option value='".$row->id_unit_kerja.'#'.$row->id_unit."'>".$row->unit_kerja.'#'.$row->id_unit."</option>";
                }
        ...
        function ambil_satuankerja()
	{
	        $state=$this->input->post('state');
                ...
                {
                 echo "<option value='".$rowget->id_satuan_kerja.'#'.$rowget->id_atasan.'#'.$rowget->id_unit."'>".$rowget->satuan_kerja.' - '.$rowget->id_atasan."</option>";
        ...
        function ambil_jfu()
	{
	        $state=$this->input->post('state');
                ...
                {
                 echo "<option value='".$rowgets->id_jfu.'#'.$rowgets->id_atasan."'>".$rowgets->jfu.' - '.$rowgets->id_atasan."</option>";
