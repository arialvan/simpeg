      ...
      public function ambil_tb_jabatan()
        {
            ...
            $sql="select * FROM tb_kelompok_organisasi join tb_jabatan_struktural "
               ...
               //. "right join tb_jabatan_jfu on tb_kelompok_organisasi.id_jfu=tb_jabatan_jfu.id_jfu"
        ...
        {
            $state=$this->input->post("state");
            $sql="select * FROM tb_kelompok_organisasi join tb_jabatan_jfu on tb_kelompok_organisasi.id_jfu=tb_jabatan_jfu.id_jfu where tb_kelompok_organisasi.id_satuan_kerja ='$state'";
            $query=$this->db->query($sql);
            return $query;
        }
