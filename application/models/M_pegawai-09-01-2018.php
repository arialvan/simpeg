...
/*PEGAWAI*/
    ...
    function show_pegawai_setting(){        
        $this->db->select('nip,nama_peg,status_peg,status_profesi,status_profil,status_atasan')
                 ->from('tb_pegawai');
...
/*INSERT ATASAN */
    function insert_atasan($data,$table) {
        $this->db->insert($table, $data); 
      ...
      public function ambil_tb_jabatan()
        {
            ...
            $sql="select * FROM tb_kelompok_organisasi join tb_jabatan_struktural on tb_kelompok_organisasi.id_jabatan=tb_jabatan_struktural.id_jabatan where tb_kelompok_organisasi.id_unit ='$state' group by tb_kelompok_organisasi.id_jabatan";
        ...
        {
            $state=$this->input->post("state");
            $sql="select * FROM tb_kelompok_organisasi join tb_unit_kerja on tb_kelompok_organisasi.id_unit_kerja=tb_unit_kerja.id_unit_kerja where tb_kelompok_organisasi.id_jabatan ='$state' group by tb_kelompok_organisasi.id_unit_kerja";
            $query=$this->db->query($sql);
            return $query;
        }
        ...
        {
            $state=$this->input->post("state");
            $sql="select * FROM tb_kelompok_organisasi join tb_satuan_kerja on tb_kelompok_organisasi.id_satuan_kerja=tb_satuan_kerja.id_satuan_kerja where tb_kelompok_organisasi.id_unit_kerja ='$state' group by tb_kelompok_organisasi.id_satuan_kerja";
            $query=$this->db->query($sql);
            return $query;
        }
